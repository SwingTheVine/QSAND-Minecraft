...
public class TileEntityRenderer extends TileEntitySpecialRenderer {
	...
	public void renderLarvae(final TileEntityLarvae par1TileEntityLarvae, final double par2, final double par4,
		...
		boolean z_inc = true;
		boolean z_dec = true;
		x_inc = ((BlockLarvae) QSAND_Blocks.larvae).shouldSideBeRendered2(par1TileEntityLarvae.getWorld(),
			par1TileEntityLarvae.getPos().getX() + 1, par1TileEntityLarvae.getPos().getY(),
			par1TileEntityLarvae.getPos().getZ(), 0);
		x_dec = ((BlockLarvae) QSAND_Blocks.larvae).shouldSideBeRendered2(par1TileEntityLarvae.getWorld(),
			par1TileEntityLarvae.getPos().getX() - 1, par1TileEntityLarvae.getPos().getY(),
			par1TileEntityLarvae.getPos().getZ(), 0);
		y_inc = ((BlockLarvae) QSAND_Blocks.larvae).shouldSideBeRendered2(par1TileEntityLarvae.getWorld(),
			par1TileEntityLarvae.getPos().getX(), par1TileEntityLarvae.getPos().getY(),
			par1TileEntityLarvae.getPos().getZ(), 1);
		y_dec = ((BlockLarvae) QSAND_Blocks.larvae).shouldSideBeRendered2(par1TileEntityLarvae.getWorld(),
			par1TileEntityLarvae.getPos().getX(), par1TileEntityLarvae.getPos().getY(),
			par1TileEntityLarvae.getPos().getZ(), 2);
		z_inc = ((BlockLarvae) QSAND_Blocks.larvae).shouldSideBeRendered2(par1TileEntityLarvae.getWorld(),
			par1TileEntityLarvae.getPos().getX(), par1TileEntityLarvae.getPos().getY(),
