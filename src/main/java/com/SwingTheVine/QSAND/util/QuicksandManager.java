...
public class QuicksandManager {
	...
	public static void spawnMudTentacles(final World world, final Entity entity, final int blockPosX, final int blockPosY, final int blockPosZ, final Block block, final int metadata, final int rate, final int chance) {
		...
		if (ConfigHandler.useMudTentacles
			...
			if (effectWeakLevel <= -1 || effectSlowLevel <= 2) {
				...
				world.spawnEntityInWorld((Entity)new EntityTentaclesMud(world, entity.posX, Math.min(entity.posY + 0.5, blockPosY + 1), entity.posZ, (Entity)entity, blockPosY + 1, 0));
			}
		}
	}
	...
	public static void spawnBubble(final World world, final double blockPosX, final double blockPosY, final double blockPosZ, final SinkingBlock block, final int metadata, final float size, final int time) {
        world.spawnEntityInWorld((Entity)new EntityBubble(world, blockPosX, blockPosY, blockPosZ, block, metadata, size, time));
    }
	
	// Spawns a bubble on a delay
	public static void spawnBubbleDelay(final World world, final double blockPosX, final double blockPosY, final double blockPosZ, final SinkingBlock block, final int metadata, final float size, final int time, final int delay) {
        world.spawnEntityInWorld((Entity)new EntityBubble(world, blockPosX, blockPosY, blockPosZ, block, metadata, size, time, delay));
    }
	
	// Spawns a random body bubble
	public static void spawnBodyBubble(final World world, final Entity entity, final int blockPosX, final int blockPosY, final int blockPosZ, final SinkingBlock block, boolean useMetadata) {
		int blockMetadata = 0;
	...
	public static void spawnStickBubble(final World world, final double x, final double y, final double z, final SinkingBlock block, boolean useMetadata, final boolean deep) {
