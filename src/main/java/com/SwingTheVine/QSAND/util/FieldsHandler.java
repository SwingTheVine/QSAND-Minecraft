...
public class FieldsHandler {
	...
	public static Object findFieldAndGet(final Class<?> target, final Class<?> fieldType, final Object targetObject,
		int index) {
	...
	public static Object[] findFieldsAndGet(final Class<?> target, final Class<?> fieldType,
	...
	public static <T> Field removeFinal(final Class<? super T> classToAccess, final T instance,
		final String... fieldNames) {
		
		final Field field = ReflectionHelper.findField(classToAccess,
