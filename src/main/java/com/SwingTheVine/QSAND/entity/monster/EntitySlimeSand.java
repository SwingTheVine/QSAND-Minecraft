...
public class EntitySlimeSand extends EntityLiving implements IMob {
	...
	public static final String textureLocation = "textures/entity/slime/Sand.png"; // The location of the texture used for the bubble
	public int datawatcherDepthID = 13; // Default datawatcher ID 
	public int datawatcherSizeID = 14; // Default datawatcher ID
	
	// Constructor
	public EntitySlimeSand(World world) {
		super(world);
    ...
    public void onCollideWithPlayer(final EntityPlayer player) {
        ...
        if (this.canDamagePlayer()) {
            ...
            if (!(player.ridingEntity instanceof EntitySlimeVoid) && !(player.ridingEntity instanceof EntitySlimeMud) && !(player.ridingEntity instanceof EntitySlimeTar) && !(player.ridingEntity instanceof EntitySlimeSand)) {
