...
public class EntityBubble extends Entity {
	...
	// Constructor
	public EntityBubble(final World world, final double bubblePosX, final double bubblePosY, final double bubblePosZ, final SinkingBlock block, final int blockMetadata, final float size, final int time) {
	...
	// Constructor
	public EntityBubble(final World world, final double blockPosX, final double blockPosY, final double blockPosZ, final SinkingBlock block, final int metadata, final float size, final int time, final int delay) {
