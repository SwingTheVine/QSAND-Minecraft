...
public class EntityTentacles extends Entity implements IEntityAdditionalSpawnData {
    ...
    public EntityTentacles(final World world, final double entityPosX, final double entityPosY, final double entityPosZ, final Entity target, final int high, final int animationLifeTime) {
        this(world);
