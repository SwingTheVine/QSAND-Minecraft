...
/** Controls the AI of Sand Slime entities.
 * 
 * @since <b>0.34.0</b>
...
public class EntityAISlimeSand {
	
	private final World world;
	private final Class<? extends Entity> player;
	private final EntitySlimeSand slime;
	private final EntityAINearestAttackableTarget.Sorter sorter;
	
	private final Random random = new Random(30);
	
	// Constructor
	public EntityAISlimeSand(final World world, final Class<? extends Entity> player, final EntitySlimeSand slime) {
	...
	public static class AISlimeAttack extends EntityAIBase {
		...
		public void updateTask() {
			...
			// Unknown
			((EntityAISlimeSand.SlimeMoveHelper) this.slime.getMoveHelper()).func_179920_a(this.slime.rotationYaw,
	...
	public static class AISlimeFaceRandom extends EntityAIBase {
		...
		// Constructor
		public AISlimeFaceRandom(final EntitySlimeSand slime) {
			this.slime = slime; // The current slime
			this.setMutexBits(2); // If this task has to run async or sync
		}
		...
		public void updateTask() {
			...
			// Rotates the slime
			((EntityAISlimeSand.SlimeMoveHelper) this.slime.getMoveHelper()).func_179920_a(this.slimeYaw, false);
		}
	}
	...
	public static class AISlimeHop extends EntityAIBase {
		...
		// Constructor
		public AISlimeHop(final EntitySlimeSand slime) {
			this.slime = slime; // The current slime
		...
		public void updateTask() {
			...
			((EntityAISlimeSand.SlimeMoveHelper) this.slime.getMoveHelper()).setSpeed(1.0D);
		}
	}
	...
	public static class SlimeMoveHelper extends EntityMoveHelper {
		...
		// Constructor
		public SlimeMoveHelper(final EntitySlimeSand slime) {
