...
public class SlimeVoidAI {

	private World world;
	private Class <? extends Entity> player;
	private SlimeVoid slime;
	private final EntityAINearestAttackableTarget.Sorter sorter;
	
	// Constructor
	public SlimeVoidAI(World world, Class <? extends Entity> player, SlimeVoid slime) {
	...
	public static class AISlimeAttack extends EntityAIBase {
        ...
        public void updateTask() {
            ...
            // Unknown
            ((SlimeVoidAI.SlimeMoveHelper)this.slime.getMoveHelper()).func_179920_a(this.slime.rotationYaw, this.slime.canDamagePlayer());
        }
    }
	...
	public static class AISlimeFaceRandom extends EntityAIBase {
	        ...
	        // Constructor
	        public AISlimeFaceRandom(SlimeVoid slime) {
	            this.slime = slime; // The current slime
	            this.setMutexBits(2); // If this task has to run async or sync
	        }
	        ...
	        public void updateTask() {
	            ...
	            // Rotates the slime
	            ((SlimeVoidAI.SlimeMoveHelper)this.slime.getMoveHelper()).func_179920_a(this.slimeYaw, false);
	        }
	    }
	...
	public static class AISlimeHop extends EntityAIBase {
	        ...
	        // Constructor
	        public AISlimeHop(SlimeVoid slime) {
	            this.slime = slime; // The current slime
	        ...
	        public void updateTask() {
	            ...
	            ((SlimeVoidAI.SlimeMoveHelper)this.slime.getMoveHelper()).setSpeed(1.0D);
	        }
	    }
	...
	public static class SlimeMoveHelper extends EntityMoveHelper {
	        ...
	        // Constructor
	        public SlimeMoveHelper(SlimeVoid slime) {
