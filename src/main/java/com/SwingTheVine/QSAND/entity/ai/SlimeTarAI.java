...
public class SlimeTarAI {

	private World world;
	private Class <? extends Entity> player;
	private SlimeTar slime;
	private final EntityAINearestAttackableTarget.Sorter sorter;
	
	// Constructor
	public SlimeTarAI(World world, Class <? extends Entity> player, SlimeTar slime) {
	...
	public static class AISlimeAttack extends EntityAIBase {
        ...
        public void updateTask() {
            ...
            // Unknown
            ((SlimeTarAI.SlimeMoveHelper)this.slime.getMoveHelper()).func_179920_a(this.slime.rotationYaw, this.slime.canDamagePlayer());
        }
    }
	...
	public static class AISlimeFaceRandom extends EntityAIBase {
	        ...
	        // Constructor
	        public AISlimeFaceRandom(SlimeTar slime) {
	            this.slime = slime; // The current slime
	            this.setMutexBits(2); // If this task has to run async or sync
	        }
	        ...
	        public void updateTask() {
	            ...
	            // Rotates the slime
	            ((SlimeTarAI.SlimeMoveHelper)this.slime.getMoveHelper()).func_179920_a(this.slimeYaw, false);
	        }
	    }
	...
	public static class AISlimeHop extends EntityAIBase {
	        ...
	        // Constructor
	        public AISlimeHop(SlimeTar slime) {
	            this.slime = slime; // The current slime
	        ...
	        public void updateTask() {
	            ...
	            ((SlimeTarAI.SlimeMoveHelper)this.slime.getMoveHelper()).setSpeed(1.0D);
	        }
	    }
	...
	public static class SlimeMoveHelper extends EntityMoveHelper {
	        ...
	        // Constructor
	        public SlimeMoveHelper(SlimeTar slime) {
