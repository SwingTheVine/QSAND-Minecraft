...
public class EntityAISlimeMud {
	...
	private EntitySlimeMud slime;
	private final EntityAINearestAttackableTarget.Sorter sorter;
	
	private Random random = new Random(30);
	
	// Constructor
	public EntityAISlimeMud(World world, Class <? extends Entity> player, EntitySlimeMud slime) {
	...
	public static class AISlimeAttack extends EntityAIBase {
        ...
        public void updateTask() {
            ...
            // Unknown
            ((EntityAISlimeMud.SlimeMoveHelper)this.slime.getMoveHelper()).func_179920_a(this.slime.rotationYaw, this.slime.canDamagePlayer());
        }
    }
	...
	public static class AISlimeFaceRandom extends EntityAIBase {
	        ...
	        // Constructor
	        public AISlimeFaceRandom(EntitySlimeMud slime) {
	            this.slime = slime; // The current slime
	            this.setMutexBits(2); // If this task has to run async or sync
	        }
	...
	public static class AISlimeHop extends EntityAIBase {
	        ...
	        // Constructor
	        public AISlimeHop(EntitySlimeMud slime) {
	            this.slime = slime; // The current slime
	...
	public static class SlimeMoveHelper extends EntityMoveHelper {
	        ...
	        // Constructor
	        public SlimeMoveHelper(EntitySlimeMud slime) {
