...
/** Controls the AI of Tar Slime entities.
 * 
 * @since <b>0.42.0</b>
...
public class EntityAISlimeTar {
	
	private final World world;
	private final Class<? extends Entity> player;
	private final EntitySlimeTar slime;
	private final EntityAINearestAttackableTarget.Sorter sorter;
	
	// Constructor
	public EntityAISlimeTar(final World world, final Class<? extends Entity> player, final EntitySlimeTar slime) {
	...
	public static class AISlimeAttack extends EntityAIBase {
		...
		public void updateTask() {
			...
			// Unknown
			((EntityAISlimeTar.SlimeMoveHelper) this.slime.getMoveHelper()).func_179920_a(this.slime.rotationYaw,
	...
	public static class AISlimeFaceRandom extends EntityAIBase {
		...
		// Constructor
		public AISlimeFaceRandom(final EntitySlimeTar slime) {
			this.slime = slime; // The current slime
			this.setMutexBits(2); // If this task has to run async or sync
		}
		...
		public void updateTask() {
			...
			// Rotates the slime
			((EntityAISlimeTar.SlimeMoveHelper) this.slime.getMoveHelper()).func_179920_a(this.slimeYaw, false);
		}
	}
	...
	public static class AISlimeHop extends EntityAIBase {
		...
		// Constructor
		public AISlimeHop(final EntitySlimeTar slime) {
			this.slime = slime; // The current slime
		...
		public void updateTask() {
			...
			((EntityAISlimeTar.SlimeMoveHelper) this.slime.getMoveHelper()).setSpeed(1.0D);
		}
	}
	...
	public static class SlimeMoveHelper extends EntityMoveHelper {
		...
		// Constructor
		public SlimeMoveHelper(final EntitySlimeTar slime) {
