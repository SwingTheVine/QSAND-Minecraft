...
/** Controls the AI of Void Slime entities.
 * 
 * @since <b>0.42.0</b>
...
public class EntityAISlimeVoid {
	
	private final World world;
	private final Class<? extends Entity> player;
	private final EntitySlimeVoid slime;
	private final EntityAINearestAttackableTarget.Sorter sorter;
	
	// Constructor
	public EntityAISlimeVoid(final World world, final Class<? extends Entity> player, final EntitySlimeVoid slime) {
	...
	public static class AISlimeAttack extends EntityAIBase {
		...
		public void updateTask() {
			...
			// Unknown
			((EntityAISlimeVoid.SlimeMoveHelper) this.slime.getMoveHelper()).func_179920_a(this.slime.rotationYaw,
	...
	public static class AISlimeFaceRandom extends EntityAIBase {
		...
		// Constructor
		public AISlimeFaceRandom(final EntitySlimeVoid slime) {
			this.slime = slime; // The current slime
			this.setMutexBits(2); // If this task has to run async or sync
		}
		...
		public void updateTask() {
			...
			// Rotates the slime
			((EntityAISlimeVoid.SlimeMoveHelper) this.slime.getMoveHelper()).func_179920_a(this.slimeYaw, false);
		}
	}
	...
	public static class AISlimeHop extends EntityAIBase {
		...
		// Constructor
		public AISlimeHop(final EntitySlimeVoid slime) {
			this.slime = slime; // The current slime
		...
		public void updateTask() {
			...
			((EntityAISlimeVoid.SlimeMoveHelper) this.slime.getMoveHelper()).setSpeed(1.0D);
		}
	}
	...
	public static class SlimeMoveHelper extends EntityMoveHelper {
		...
		// Constructor
		public SlimeMoveHelper(final EntitySlimeVoid slime) {
