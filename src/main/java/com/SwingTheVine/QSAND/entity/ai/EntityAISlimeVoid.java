...
public class EntityAISlimeVoid {
	...
	private EntitySlimeVoid slime;
	private final EntityAINearestAttackableTarget.Sorter sorter;
	
	// Constructor
	public EntityAISlimeVoid(World world, Class <? extends Entity> player, EntitySlimeVoid slime) {
	...
	public static class AISlimeAttack extends EntityAIBase {
        ...
        public void updateTask() {
            ...
            // Unknown
            ((EntityAISlimeVoid.SlimeMoveHelper)this.slime.getMoveHelper()).func_179920_a(this.slime.rotationYaw, this.slime.canDamagePlayer());
        }
    }
	...
	public static class AISlimeFaceRandom extends EntityAIBase {
	        ...
	        // Constructor
	        public AISlimeFaceRandom(EntitySlimeVoid slime) {
	            this.slime = slime; // The current slime
	            this.setMutexBits(2); // If this task has to run async or sync
	        }
	...
	public static class AISlimeHop extends EntityAIBase {
	        ...
	        // Constructor
	        public AISlimeHop(EntitySlimeVoid slime) {
	            this.slime = slime; // The current slime
	...
	public static class SlimeMoveHelper extends EntityMoveHelper {
	        ...
	        // Constructor
	        public SlimeMoveHelper(EntitySlimeVoid slime) {
