...
import com.SwingTheVine.QSAND.entity.ai.SlimeVoidAI;
...
public class SlimeVoid extends EntityLiving implements IMob {
	...
	public static final String textureLocation = ":textures/entities/SlimeVoid.png"; // The location of the texture used for the bubble
	public int datawatcherDepthID = 13; // Default datawatcher ID 
	public int datawatcherSizeID = 14; // Default datawatcher ID
	
	// Constructor
	public SlimeVoid(World world) {
		super(world);
		...
		this.moveHelper = new SlimeVoidAI.SlimeMoveHelper(this);
        this.targetTasks.addTask(1, new EntityAIFindEntityNearestPlayer(this));
        this.tasks.addTask(2, new SlimeVoidAI.AISlimeAttack(this));
        this.tasks.addTask(3, new SlimeVoidAI.AISlimeFaceRandom(this));
        this.tasks.addTask(4, new SlimeVoidAI.AISlimeHop(this));
	}
    ...
    protected SlimeVoid createInstance() {
        return new SlimeVoid(this.worldObj);
    }
    ...
    public void onUpdate() {
        ...
        if (this.onGround && !isOnGround) {
            ...
            for (int slimeSize = this.getSlimeSize(), particle = 0; particle < slimeSize * 16; particle++) {
                ...
                this.worldObj.spawnParticle(EnumParticleTypes.WATER_SPLASH, true, this.posX + offsetX, this.getEntityBoundingBox().minY, this.posZ + offsetZ, 0.0, 0.0, 0.0);
            }
        ...
        if (this.riddenByEntity == null) {
            ...
            if (this.deepFactor < 12.5f) {
                ...
                if (initialPullTime <= 0.0f) {
                    ...
                    this.pullTime = (float)(45 + this.rand.nextInt(10)); // Set pullTime to a number between 45 and 54
    ...
    public void onCollideWithPlayer(final EntityPlayer player) {
        ...
        if (this.canDamagePlayer()) {
            ...
            if (!(player.ridingEntity instanceof SlimeVoid) && !(player.ridingEntity instanceof SlimeMud) && !(player.ridingEntity instanceof SlimeTar) && !(player.ridingEntity instanceof SlimeVoid)) {
    ...
    public boolean getCanSpawnHere() {
        ...
        if (this.worldObj.getDifficulty() != EnumDifficulty.PEACEFUL) {
            final BiomeGenBase var2 = this.worldObj.getBiomeGenForCoords(new BlockPos(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.posY), MathHelper.floor_double(this.posZ)));
